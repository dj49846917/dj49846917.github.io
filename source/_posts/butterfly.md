---
title: butterfly主题的设置                                                                      # 标题(必填)
date: 2020年6月24日                                                                  # 开始时间(必填)
updated: 2020年6月24日                                                               # 更新时间
...
## 使用主题
修改修改根路径下的_config.yml，把主題改為butterfly
```
theme: butterfly
```
...
```
  ...
  social:
    fab fa-github: https://github.com/dj49846917 || Github
    fas fa-envelope: 821084785@qq.com || Email
  ...
  footer_custom_text: Hi, welcome to my <a href="https://dj49846917.github.io/">blog</a>!
  ...
  runtimeshow:
    enable: true
    publish_date: 2020/6/21 12:00:00
